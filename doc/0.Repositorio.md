# 0 Nivel: Mecánica de la materia + planteamiento de un proyecto para la misma
...
resolviendo, a través de la materia, usando software, y en equipo. Este problema
...
componente externo (en forma de servicios o de componentes materiales).

La forma normal de trabajar en las empresas de desarrollo de software es en
equipo. En este nivel quedarán los equipos configurados, usando los que se
hayan constituido anteriormente o creándolos desde cero.
...
aquí. En el [siguiente nivel](1.Planificacion.md) tendrás que plantear los
...
desarrollo para este y otros proyectos, lo que incluye
...
Una vez entregado, podéis empezar con [el
