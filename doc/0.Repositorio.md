...
que se va a llevar en esta materia.

A la vez, el estudiante tendrá que describir un problema general que se irá
resolviendo, a través de la materia, usando software. Este problema tendrá
...
En estos primeros compases de la materia es *imprescindible* la **asistencia
...
llevar a cabo su desarrollo durante el resto de la materia.
