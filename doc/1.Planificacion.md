# Nivel 1: Estructura general y planificación del proyecto
...
Como en el [nivel anterior](0.Repositorio.md), se aconseja vivamente la
...
revisores de cada PR entre miembros de otros equipos que ya lo hayan
superado. Cuando se haga el PR en el repositorio de la asignatura, se sacarán
hasta cinco *nicks* aleatoriamente. No es obligatorio hacer la revisión para
quien se elija, pero sí se considerará positivamente en la nota final en el
