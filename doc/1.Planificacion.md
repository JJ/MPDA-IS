...
## Este objetivo es fundamental para el resto de la materia
...
contenido; en objetivos sucesivos se trabajará sobre ellos, no sobre el
texto. También conviene que el texto usado para pasar de nivel se traslade al Wiki del
mismo, ya que suele ser el lugar adecuado para incluir la documentación de un
proyecto; en el repositorio tiene que quedar solamente el código y la
documentación necesaria para desarrollar usando el mismo.
