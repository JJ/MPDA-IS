...
que es esencial comprender las historias de usuario planteadas en el [primer
nivel](1.Planificacion.md) y partir de las mismas para poder resolver el
problema.
...
### Estamos trabajando en un repositorio pero no contestan a mis preguntas
