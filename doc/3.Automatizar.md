...
Seguramente de forma directa al [nivel 5](5.Tests.md), ya que el nivel 4 estará
posiblemente ya aceptado. Antes de ir, una reunión final de este sprint que
establezca qué ha funcionado bien y qué no lo ha hecho ayudará a establecer una
base sólida de trabajo para los siguientes niveles.
