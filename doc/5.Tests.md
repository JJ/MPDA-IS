...
de test para **lenguaje x** y poner el primero que aparezca en Google o te diga
ChatGPT".  Hay que demostrar que realmente se entiende qué es un *test runner*,
en qué se diferencia de una biblioteca de aserciones, y que se han tomado las
elecciones más adecuadas, tras establecer unos criterios *antes de la elección*
