...
> referencia](https://docs.github.com/en/actions/using-workflows/workflow-syntax-for-github-actions). Se
> aconseja que se use este manual para hacer cualquier otra activida o activar
> opciones que no tienen reflejo en este ejemplo.


Un ejemplo es
este, integrado en este repositorio
...
* `on`: establece las condiciones en las cuales se va a activar este flujo; si
  ...
  especificada en el manual anterior, pero en este caso indica qu eserá
